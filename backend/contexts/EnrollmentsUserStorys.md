...
**注**: 学生管理機能は [StudentRegistrationsUserStory.md](StudentRegistrationsUserStory.md) に移動しました。

### 学期管理 (Phase 2 - 完了) → エピック1
...
詳細は [StudentRegistrationsUserStory.md](StudentRegistrationsUserStory.md) を参照してください。

**理由**: 最もシンプルで他機能への依存なし。学生の在籍情報管理が全ての履修管理の前提。

### Phase 2: 学期管理（完了済み） → エピック1
